# getcleandata
This document describes the run_analysis.R and tidy_data_set.txt files which were submitted for the Getting and Cleaning Data Coursera course project (July 2015).
